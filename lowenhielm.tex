...
\texttt{10 \textbf{LET} oss nu fatta i våra glas\\
20 \textbf{INPUT} en klunk utav det som där has\\
30 \textbf{IF} du fatt nog \textbf{THEN} till 50 min vän\\
40 \textbf{ELSE} \textbf{GOTO}-baka till 10 igen\\
50 \textbf{END}}
